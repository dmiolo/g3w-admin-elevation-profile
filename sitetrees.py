...
sitetrees = (
  ...
  G3Wtree('eleprofile', title='ElevationProfile', module='eleprofile', items=[
      # Then define items and their children with `item` function.
      item('Aggiungi un progetto di Profilo Altimentrico', 'qdjango-project-add group.slug', in_menu=False,
  ...
  G3Wtree('eleprofile_en', title='ElevationProfile', module='eleprofile', items=[
      # Then define items and their children with `item` function.
